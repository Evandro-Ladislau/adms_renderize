...
if (!empty($id)) {
    ...
    if ($_SESSION['adms_niveis_acesso_id'] == 1) {
        ...
        //DEPOOIS MELHORAR ESSE SELECT, SE FOR PRECISO VAI TER QUE CRIAR OUTRA QUERY
        //PARA NÃO FICAR IGUAL A QUERY ACIMA.
        $result_niv_ac = $pdo->permissaoSuperAdministrador($id, $inicio, $qnt_result_pg);
    }
                    ...
                    <div class="list-group-item">
                        <div class="d-flex">
                            <div class="mr-auto p-2">
                                <?php
                                $result_nome_nivac = $pdo->nomeNivelAcesso($id);
                                ?>
                                <h2 class="display-4 titulo">Listar Permissões - <?php echo $result_nome_nivac[0]['nome']; ?></h2>
                            </div>
                            <div class="p-2">
                                <?php
                        ...
                        <div class="table-responsive">
                            <table class="table table table-bordered table-striped table-hover ">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <th><?php echo $result_niv_ac[$i]['id']; ?></th>
                                            <td>
                                                <span tabindex="0" data-placement="top" data-toggle="tooltip" title="<?php
                                                echo $result_niv_ac[$i]['obs']
                                                ?>">
                                                    <i class="fas fa-question-circle"></i>
                                                </span>
                                                <?php
                                                echo $result_niv_ac[$i]['nome_pagina'];
                                                ...
                                                <?php 
                                                 ...
                                                 if ($btn_ordem_menu) {
                                                     if ($qnt_linhas_exe == 1) {
                                                        ...
                                                        echo "<a href='" . pg . "/processa/proc_ordem_menu?id=".$result_niv_ac[$i]['id']."' class='btn btn-outline-secondary btn-sm'><i class='fas fa-angle-double-up'></i></a>";
                                                     }
                                                 }
                                                 $qnt_linhas_exe++;
                                                ?>
